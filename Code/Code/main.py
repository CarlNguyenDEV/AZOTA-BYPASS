...
def main():
    ...
    time.sleep(0.1)
    #Hashchange
    pag.locateOnScreen("5.png", confidence=0.3)
    time.sleep(0.1)
    pag.click("5.png")
    pointclick5 = (pag.locateOnScreen("Remove_2.png", confidence=0.7).left + 88, pag.locateOnScreen("Remove_2.png", confidence=0.7).top + 10)
    time.sleep(0.1)
    pag.click(pointclick5)
    time.sleep(0.1)
    #Load
    ...
    time.sleep(0.1)
    #Orient
    pag.locateOnScreen("9.png", confidence=0.5)
    time.sleep(0.1)
    pag.click("9.png")
    pointclick9 = (pag.locateOnScreen("Remove_2.png", confidence=0.7).left + 88, pag.locateOnScreen("Remove_2.png", confidence=0.7).top + 10)
    time.sleep(0.1)
    pag.click(pointclick9)
    time.sleep(0.3)
    #Popstate
    ...
    time.sleep(0.1)
    #Resize
    pag.locateOnScreen("11.png", confidence=0.6)
    time.sleep(0.3)
    pag.click("11.png")
    pointclick11 = (pag.locateOnScreen("Remove_2.png", confidence=0.7).left + 88, pag.locateOnScreen("Remove_2.png", confidence=0.7).top + 10)
    time.sleep(0.1)
    pag.click(pointclick11)
    time.sleep(0.1)
    pag.click(pointclick11)
    time.sleep(0.1)
    #Scroll
