...
def main():
    ...
    time.sleep(0.3)
    #Resize
    pag.locateOnScreen("11.png", confidence=0.4)
    time.sleep(0.3)
    pag.click("11.png")
    ...
    time.sleep(0.1)
    #Visibilitychange
    pag.locateOnScreen("visible.png")
    time.sleep(0.2)
    pag.click("visible.png")
    pointclickr = (pag.locateOnScreen("doc_remove.png", confidence=0.6).left + 102, pag.locateOnScreen("doc_remove.png",confidence=0.6).top + 11)
    time.sleep(0.1)
    pag.click(pointclickr)
    time.sleep(0.1)
    #OUT
